...
START_TEST(test_scrollback_buffer_add_data)
{
    ...
    // Assert.
    mud_string *expected_line0 = mud_string_create_from_c_string(256, "a");
    ...
    mud_string *expected_line1 = mud_string_create_from_c_string(256, "test");
    ...
    mud_string *expected_line2 = mud_string_create_from_c_string(256, "this");
    ...
    mud_string *expected_line3 = mud_string_create_from_c_string(256, "is");
